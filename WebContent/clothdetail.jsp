...
<%try{
  ...
  <div class="column">
    <div class="card">
    <img src="assets/img/bcloth.jpg" height="180"/>
  	 <h3 class="texts"><span class="labels"> Name: </span><%=resultSet.getString("name") %></h3>
     <h3 class="texts"><span class="labels">Brand Name: </span><%=resultSet.getString("brand_name") %></h3>
     <h3 class="texts"><span class="labels">Size:  </span><%=resultSet.getString("size") %></h3>
