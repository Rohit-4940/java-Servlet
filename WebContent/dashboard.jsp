...
<title>Welcome to Fitness Supplier</title>
 <!-- meta data & title -->
        <meta charset="utf-8">
        <title>Fitness Suppliers Pvt</title>
...
<!-- Header -->
                ...
                <div id="carousel-1" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item active">
                            <img src="assets/img/slider/slide1.jpg" height="200" alt="Image of first carousel">
                        ...
                        <!-- Begin Slide 2 -->
                        <div class="item">
                            <img src="assets/img/slider/slide4.jpg" height="200" alt="Image of third carousel">
                            <div class="carousel-caption">
                        ...
                        <!-- Begin Slide 3 -->
                        <div class="item">
                            <img src="assets/img/slider/slide5.jpg" height="200" alt="Image of third carousel">
                            <div class="carousel-caption">
                            </div>
                        </div>
                        <!-- End Slide 3 -->
   ...
   <section id="services" class="services-section section-global-wrapper">
        <div class="container">
            ...
            <div class="row services-row services-row-head services-row-1">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <a href="productdetail.jsp"><img src="assets/img/product.jpg" height="255px" width="362px"/></a>
                    <div class="centered"> <a href="productdetail.jsp">Product </a></div>
                    <button class="centered"><a href="productdetail.jsp">Product</a> </button>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class=" wow animated zoomIn" data-wow-offset="40">
                        ...
                        <div class="centered"> <a href="clothdetail.jsp">Cloth</a></div>
                    <button class="centered"><a href="clothdetail.jsp">Cloth</a> </button>
            ...
            <div class="row services-row services-row-tail services-row-2">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class=" wow animated fadeInLeft" data-wow-offset="40">
                         ...
                         <div class="centered"> <a href="pshakedetail.jsp">Protein Shake</a></div>
                    <button class="centered"><a href="pshakedetail.jsp">Protein Shake</a> </button>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="wow animated zoomIn" data-wow-offset="40">
                        ...
                        <div class="centered"> <a href="bproteindetail.jsp">Product Bar</a></div>
                    <button class="centered"><a href="bproteindetail.jsp">Product Bar</a> </button>
    ...
    <div class="copyright text center">
        <p class="footers">&copy; Copyright 2020, Sumeru Fitness Suppliers Pvt</a></p>
    </div>
</form>
