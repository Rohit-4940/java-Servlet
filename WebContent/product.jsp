...
<nav class="navbar">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav menu pull-right">
      ...
      <li><a href="LogoutServlet" class="menu"><span class="glyphicon glyphicon-log-in"></span> Logout  <%=request.getAttribute("Admin") %></a></li>
      </ul>
  </div>
</nav>
    <div class="container">
        <div class="table-wrapper">
            ...
            <g:forEach items="${allproductList}" var="list">
                <tr> 
                	<td>${list.id}</td>
                    <td>${list.name}</td>
                    ...
                    <td>${list.price}</td>
                    <td><a href="productServlet?action=DELETE&id=${list.id}" data-toggle="modal">Delete</a>
                    |<a href="productServlet?id=${list.id}&act=edit"  data-toggle="modal">Edit</a></td>
                </tr>
            </g:forEach>
				...
				<form action="productServlet" method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="date" class="form-control" required name="manufacture_date">
						</div>
						<div class="form-group">
